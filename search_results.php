    ...
    <div class="sidebar-elements search-bx">
        ...
        <?php
            ...
            if(isset($_REQUEST['search'])){
                ...
                $jobs = $Job->filterJobs($keyword, $type, $category,$a, $location);
            ...
            <div class="twm-sidebar-ele-filter">
                ...
                <ul>
                    <li>
                        ...
                        <span class="twm-job-type-count"><?php echo count($Job->where('job','employment_type','Freelance')) ?></span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="twm-job-type-count"><?php echo count($Job->where('job','employment_type','Full Time')) ?></span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="twm-job-type-count"><?php echo count($Job->where('job','employment_type','Part Time')) ?></span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="twm-job-type-count"><?php echo count($Job->where('job','employment_type','Contract')) ?></span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="twm-job-type-count"><?php echo count($Job->where('job','employment_type','Internship')) ?></span>
                    </li>
            ...
            <a href="job-list.html">Tips</a>
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="product-filter-wrap d-flex justify-content-between align-items-center m-b30">
                                <span class="woocommerce-result-count-left">Showing <?php echo count($jobs) ?> search results for <?php echo $a ?> jobs</span>
