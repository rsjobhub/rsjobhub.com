                                ...
                                <div class="twm-log-reg-inner">
                                    <div class="twm-log-reg-head">
                                        <div class="twm-log-reg-logo">
                                            <span class="log-reg-form-title">Login</span>
                                        </div>
                                    </div>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button id="submit" type="submit" class="site-button" name="login">Login</button>
                                                        </div>
                                                    </div>
                                                    </form>
                                    ...
                                    <?php include 'glogin.php';?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                           <a href="register.php"> <p>don't have an account? <span style="color: blue !important;">sign up </span></p></a>
                                                        </div>
                                                    </div>
