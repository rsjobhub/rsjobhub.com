                                ...
                                <div class="twm-D_table table-responsive">
                                    <table id="jobs_bookmark_table" class="table table-bordered twm-candidate-save-job-list-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $jobs = new Job;
                                            $saved_jobs = $jobs->get_all_user_saved_jobs($_SESSION['uin']);
                                            foreach($saved_jobs as $saved_job){
                                                $each_saved_job = $jobs->where('job', 'job_id', $saved_job['job_id']);
                                            foreach($each_saved_job as $each_saved_job){
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="twm-candidate-save-job-list">
                                                        ...
                                                        <div class="twm-mid-content">
                                                                <p><?php echo $each_saved_job['job_title'];?></p>
                                                ...
                                                <td><a href="javascript:;"><?php echo $each_saved_job['employment_type'];?></a></td>
                                                ...
                                                <td>
                                                    <div class="twm-table-controls">
                                                        <ul class="twm-DT-controls-icon list-unstyled">
                                                            <li>
                                                                <a target="_blank" href="job-detail.php?job_id=<?php echo $each_saved_job['job_id'] ?>" class="custom-toltip">
                                                                    <span class="fa fa-arrow-up-right-from-square"></span>
                                                                    <span class="custom-toltip-block">View details</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="delete_saved_job.php?job_id=<?php echo $each_saved_job['job_id'];?>" class="custom-toltip btn-danger"  data-bs-toggle="tooltip">

                                                               

                                                                        <span style="color: red !important;" class="far fa-trash-alt"></span>
